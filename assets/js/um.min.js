...
function prepare_Modal(){if(jQuery('.um-popup-overlay').length == 0){jQuery('body').append('<div class="um-popup-overlay"></div>');jQuery('body').append('<div class="um-popup"></div>');jQuery('.um-popup').addClass('loading')}}function remove_Modal(){if(jQuery('.um-popup-overlay').length){jQuery('.um-popup').empty().remove();jQuery('.um-popup-overlay').empty().remove()}}function show_Modal(contents){if(jQuery('.um-popup-overlay').length){jQuery('.um-popup').removeClass('loading').html(contents)}}function responsive_Modal(){if(jQuery('.um-popup-overlay').length){ag_height = jQuery(window).height() - jQuery('.um-popup-header').outerHeight() - jQuery('.um-popup-footer').outerHeight() - 40;if(ag_height>350){ag_height = 350}jQuery('.um-popup-autogrow').css({'height':ag_height+'px'});jQuery('.um-popup-autogrow').mCustomScrollbar({theme:"dark-3"}).mCustomScrollbar("scrollTo","bottom",{scrollInertia:0})}}
